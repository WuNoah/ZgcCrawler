...
public class Queue {
public volatile static Vector<String> startUrl;
private volatile static LinkedList<String> productPages;
public static HashSet<String> visitedUrl;
public static BloomFilter bloomFilter;
static{
    visitedUrl = new HashSet<>(10000);
    startUrl = new Vector<>();
    productPages = new LinkedList<>();
